...
@interface AQRootViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation AQRootViewController
...
- (void)initTableInfo {
  self.titles = [NSArray arrayWithObjects:@[ @"UIKit", @"Address", @"Network", @"Thead", @"Memory"], nil];
  self.classNames = [NSArray arrayWithObjects:@[ @"AQUIViewController",
                       @"AddressListViewController",
                       @"AQNetworkViewController",
                       @"AQThreadViewController",
                       @"MemoryManageController"], nil];
}
